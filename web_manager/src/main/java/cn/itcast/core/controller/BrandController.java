...
public class BrandController {
    ...
    @RequestMapping("/findAllApplyBrand")
    public List<BrandEntity> findAllApplyBrand() {
        List<BrandEntity> brandEntityList = brandService.findAllApplyBrand();
        return brandEntityList;
    }

    @RequestMapping("/updateBrand")
    public Result updateBrand(@RequestBody BrandEntity[] brandEntityArray) {
        brandService.updateBrand(brandEntityArray);
        return new Result(true, "商家品牌审核通过!");
    }
}
